 ...
 */
	...
	if (isset($_POST['send'])) {
		...
		$msg.= '<h1 style="border-bottom: 20px solid #F0F2F5;color:#ffffff;padding:10px 20px;background-color:#f15a29;border-radius: 5px 5px 0 0;margin-bottom: 20px;margin-top: 0;">'. $subj .'</h1>';
